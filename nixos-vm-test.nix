...
testers.nixosTest {
  ...
  testScript = ''
    ...
    machine.copy_from_machine("/tmp/flclashx.log", "diagnostics")
    machine.copy_from_machine("/tmp/flclashx-dbus.log", "diagnostics")
    machine.copy_from_machine("/tmp/flclashx-xorg.log", "diagnostics")
